...
- (void)connection:(NSURLConnection *)connection didReceiveData:(NSData *)data
{
    ...
    if ((self.options & SDWebImageDownloaderProgressiveDownload) && self.expectedSize > 0 && self.completedBlock)
    {
        ...
        CGImageSourceUpdateData(imageSource, (__bridge  CFDataRef)self.imageData, totalSize == (unsigned long)self.expectedSize);
        ...
        if (width + height > 0 && totalSize < (unsigned long)self.expectedSize)
        {
            // Create the image
